...
# INGENIOUS_AZURE_SEARCH_SERVICES__0__SEMANTIC_CONFIGURATION_NAME=default
# INGENIOUS_AZURE_SEARCH_SERVICES__0__USE_SEMANTIC_RANKING=true
# INGENIOUS_AZURE_SEARCH_SERVICES__0__TOP_K_RETRIEVAL=20
# INGENIOUS_AZURE_SEARCH_SERVICES__0__TOP_N_FINAL=5
